...
export default function Category() {
  ...
  const categories = [
    ...
    },
    {
      name: "Tuber",
      // Why local path? For images stored in your project
    image: "/assets/yams.webp",
      // Why count? Shows how many products in category
      // Why badge? Highlights special categories
    },
    {
      name: "Spices & Seasonings",
      image: "/assets/openair-spices.jpg",
    },
    {
      name: "Beverages",
      // Why Unsplash URL? Free high-quality images for prototyping
      image: "/assets/PEAK-MILK-.jpg",
    },
    {
      name: "Proteins and Meats",
      image: "/assets/smoked-fish.jpg",
    },
    {
    ...
    {
      name: "Stew & Soup",
      image: "/assets/Neogric-Melon-Seeds-2.jpg",
    },
    {
      name: "Snacks & Sweets",
      image: "/assets/plantain-chips-pack.jpg",
    },
    {
      name: "Condiments & Oils",
      image: "/assets/Red-oil.webp",
    }
  ];
